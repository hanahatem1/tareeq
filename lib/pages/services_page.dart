    ...
    return Scaffold(
     appBar:AppBar(
      automaticallyImplyLeading: false,
        ...
        title:const  Center(child: Text("choose your service",style: TextStyle(color:kprimaryColor,fontWeight: FontWeight.bold,fontFamily: kFont,fontSize: 17))),
            ...
            child: Row(
              ...
              children: [
                Container( 
                  ...
                  child:const  Center(child: Text("Most services",style: TextStyle(color: kprimaryColor,fontWeight: FontWeight.bold,fontFamily: kFont,fontSize: 14),)),
                ),
              ],
            ),
          ),
       ...
       const SizedBox(height:14),
         Container(width: 100,height: 1.8,color:const  Color(0xffe3e0db),),
